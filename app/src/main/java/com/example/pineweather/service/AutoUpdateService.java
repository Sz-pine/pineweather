package com.example.pineweather.service;
...
import com.example.pineweather.WeatherActivity;
...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent ser = new Intent(this, AutoUpdateService.class);
        PendingIntent pi = PendingIntent.getService(this, 0, ser, 0);
        manager.cancel(pi);
